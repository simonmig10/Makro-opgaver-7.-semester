...
then we take the first order conditions of $l_1$ and $l_2$ with yields: $$\frac{b}{1-l_1} = \lambda w_1 \quad and \quad \frac{e^{-\rho}b}{(1-l_2)^\gamma} = \frac{1}{1+r}\lambda w_2$$

dividing both sides of the first by $w_1$ and both sides of the second by $\frac{w_2}{1+r}$ we get: $$\frac{b}{1-l_1}\frac{1}w_1 = \lambda \quad and \quad \frac{e^{-\rho}b}{(1-l_2)^\gamma}\frac{1+r}{w_2} = \lambda$$

equating the two equations yields: $$\frac{e^{-\rho}b}{(1-l_2)^\gamma}\frac{1+r}{w_2} = \frac{b}{1-l_1}\frac{1}w_1$$
...
$gamma$ is the elasticity, the stronger the gamma the stronger the reaction on the change in wages. 
