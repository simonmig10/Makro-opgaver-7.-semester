...
givet P og 1/ao er givet skal markuppen falde og så falder pi og så stiger lønandelen.
...
In the K S model an increase in the labour share 1-pi does not reduced growth. On the contrary, t increases demand and growth. To ee this graphicly note that the reduction of pi changed the slope of g, hvilket roterer den nedad og dermed skaber en højere ligevægt for investering og derved langsigtede vækst, u, the rate of profit og real lønnen. There is no tension between thee compensation of labour (the real wage) and capital(the rate of profit) becaue the level of income has increased as denoted by the outward movement of the wage-profit line. in other words even if distribution is now more favourable for workers, this does not come at the expense of firms' absolute level of income. This would only happen if income cannot be increased, which only occurs when the rate of u is at its maximum level u = 1.
...
Given P , an increase in productivity is represented by a decrease in the unit labour requirement a0 i.e. it becomes possible to produce more with the same amout of workers. in a context of rising wages as the one descirbed in the notem, a fall in a0 could offset the upward pressure on prices, thereby leaving them constant (the overall effect on prices would ultimately depend on the relative changes of W and a0.)
